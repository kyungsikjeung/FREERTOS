...
The library functions are declared in the public file {\ttfamily \doxylink{arm__math_8h}{arm\+\_\+math.\+h}} which is placed in the {\ttfamily Include} folder. Simply include this file. If you don\textquotesingle{}t want to include everything, you can also rely on headers in Include/dsp folder and use only what you need.\hypertarget{index_example}{}\doxysection{\texorpdfstring{Examples}{Examples}}\label{index_example}
The library ships with a number of examples which demonstrate how to use the library functions.\hypertarget{index_toolchain}{}\doxysection{\texorpdfstring{Toolchain Support}{Toolchain Support}}\label{index_toolchain}
The library is now tested on Fast Models building with cmake. Core M0, M4, M7, M33, M55, A32 are tested.\hypertarget{index_preprocessor}{}\doxysection{\texorpdfstring{Preprocessor Macros}{Preprocessor Macros}}\label{index_preprocessor}
...
\DoxyHorRuler{0}
 \hypertarget{index_pack}{}\doxysection{\texorpdfstring{CMSIS-\/\+DSP in ARM\+::\+CMSIS Pack}{CMSIS-\/\+DSP in ARM\+::\+CMSIS Pack}}\label{index_pack}
...
\DoxyHorRuler{0}
 \hypertarget{index_rev}{}\doxysection{\texorpdfstring{Revision History of CMSIS-\/\+DSP}{Revision History of CMSIS-\/\+DSP}}\label{index_rev}
