...
\hypertarget{arm__vec__fft_8h_source}{}\label{arm__vec__fft_8h_source}\index{C:/Users/TOVIS/test/TestRtos/Drivers/CMSIS/DSP/PrivateInclude/arm\_vec\_fft.h@{C:/Users/TOVIS/test/TestRtos/Drivers/CMSIS/DSP/PrivateInclude/arm\_vec\_fft.h}}
...
\DoxyCodeLine{\Hypertarget{arm__vec__fft_8h_source_l00043}00043\ \textcolor{preprocessor}{\#define\ MVE\_CMPLX\_MULT\_FX\_AxB(A,B,TyA)\ \ \ \ \ \ vqdmladhxq(vqdmlsdhq((TyA)vuninitializedq\_s32(),\ A,\ B),\ A,\ B)}}
\DoxyCodeLine{\Hypertarget{arm__vec__fft_8h_source_l00044}00044\ \textcolor{preprocessor}{\#define\ MVE\_CMPLX\_MULT\_FX\_AxConjB(A,B,TyA)\ \ vqdmladhq(vqdmlsdhxq((TyA)vuninitializedq\_s32(),\ A,\ B),\ A,\ B)}}
...
\DoxyCodeLine{\Hypertarget{arm__vec__fft_8h_source_l00057}00057\ }
\DoxyCodeLine{\Hypertarget{arm__vec__fft_8h_source_l00058}00058\ \mbox{\hyperlink{_core_2_include_2cmsis__armcc_8h_aba87361bfad2ae52cfe2f40c1a1dbf9c}{\_\_STATIC\_INLINE}}\ \textcolor{keywordtype}{void}\ arm\_bitreversal\_32\_inpl\_mve(}
...
\DoxyCodeLine{\Hypertarget{arm__vec__fft_8h_source_l00134}00134\ }
\DoxyCodeLine{\Hypertarget{arm__vec__fft_8h_source_l00135}00135\ \mbox{\hyperlink{_core_2_include_2cmsis__armcc_8h_aba87361bfad2ae52cfe2f40c1a1dbf9c}{\_\_STATIC\_INLINE}}\ \textcolor{keywordtype}{void}\ arm\_bitreversal\_16\_inpl\_mve(}
...
\DoxyCodeLine{\Hypertarget{arm__vec__fft_8h_source_l00153}00153\ \ \ \ \ bitRevOff0Low\ =\ vmullbq\_int\_u16((uint16x8\_t)bitRevTabOff,\ one);}
\DoxyCodeLine{\Hypertarget{arm__vec__fft_8h_source_l00154}00154\ \ \ \ \ bitRevOff0High\ =\ vmulltq\_int\_u16((uint16x8\_t)bitRevTabOff,\ one);}
\DoxyCodeLine{\Hypertarget{arm__vec__fft_8h_source_l00155}00155\ \ \ \ \ bitRevOff0Low\ =\ vshrq\_n\_u16((uint16x8\_t)bitRevOff0Low,\ 3);}
\DoxyCodeLine{\Hypertarget{arm__vec__fft_8h_source_l00156}00156\ \ \ \ \ bitRevOff0High\ =\ vshrq\_n\_u16((uint16x8\_t)bitRevOff0High,\ 3);}
...
\DoxyCodeLine{\Hypertarget{arm__vec__fft_8h_source_l00163}00163\ \ \ \ \ \ \ \ \ bitRevOff1Low\ =\ vmullbq\_int\_u16((uint16x8\_t)bitRevTabOff,\ one);}
\DoxyCodeLine{\Hypertarget{arm__vec__fft_8h_source_l00164}00164\ \ \ \ \ \ \ \ \ bitRevOff1High\ =\ vmulltq\_int\_u16((uint16x8\_t)bitRevTabOff,\ one);}
\DoxyCodeLine{\Hypertarget{arm__vec__fft_8h_source_l00165}00165\ \ \ \ \ \ \ \ \ bitRevOff1Low\ =\ vshrq\_n\_u16((uint16x8\_t)bitRevOff1Low,\ 3);}
\DoxyCodeLine{\Hypertarget{arm__vec__fft_8h_source_l00166}00166\ \ \ \ \ \ \ \ \ bitRevOff1High\ =\ vshrq\_n\_u16((uint16x8\_t)bitRevOff1High,\ 3);}
...
\DoxyCodeLine{\Hypertarget{arm__vec__fft_8h_source_l00178}00178\ \ \ \ \ \ \ \ \ bitRevOff0Low\ =\ vmullbq\_int\_u16((uint16x8\_t)bitRevTabOff,\ one);}
\DoxyCodeLine{\Hypertarget{arm__vec__fft_8h_source_l00179}00179\ \ \ \ \ \ \ \ \ bitRevOff0High\ =\ vmulltq\_int\_u16((uint16x8\_t)bitRevTabOff,\ one);}
\DoxyCodeLine{\Hypertarget{arm__vec__fft_8h_source_l00180}00180\ \ \ \ \ \ \ \ \ bitRevOff0Low\ =\ vshrq\_n\_u16((uint16x8\_t)bitRevOff0Low,\ 3);}
\DoxyCodeLine{\Hypertarget{arm__vec__fft_8h_source_l00181}00181\ \ \ \ \ \ \ \ \ bitRevOff0High\ =\ vshrq\_n\_u16((uint16x8\_t)bitRevOff0High,\ 3);}
...
\DoxyCodeLine{\Hypertarget{arm__vec__fft_8h_source_l00212}00212\ \ \ \ \ \ \ \ \ bitRevOff0Low\ =\ vmullbq\_int\_u16((uint16x8\_t)bitRevTabOff,\ one);}
\DoxyCodeLine{\Hypertarget{arm__vec__fft_8h_source_l00213}00213\ \ \ \ \ \ \ \ \ bitRevOff0High\ =\ vmulltq\_int\_u16((uint16x8\_t)bitRevTabOff,\ one);}
\DoxyCodeLine{\Hypertarget{arm__vec__fft_8h_source_l00214}00214\ \ \ \ \ \ \ \ \ bitRevOff0Low\ =\ vshrq\_n\_u16((uint16x8\_t)bitRevOff0Low,\ 3);}
\DoxyCodeLine{\Hypertarget{arm__vec__fft_8h_source_l00215}00215\ \ \ \ \ \ \ \ \ bitRevOff0High\ =\ vshrq\_n\_u16((uint16x8\_t)bitRevOff0High,\ 3);}
...
\DoxyCodeLine{\Hypertarget{arm__vec__fft_8h_source_l00232}00232\ \mbox{\hyperlink{_core_2_include_2cmsis__armcc_8h_aba87361bfad2ae52cfe2f40c1a1dbf9c}{\_\_STATIC\_INLINE}}\ \textcolor{keywordtype}{void}\ arm\_bitreversal\_32\_outpl\_mve(\textcolor{keywordtype}{void}\ *pDst,\ \textcolor{keywordtype}{void}\ *pSrc,\ uint32\_t\ fftLen)}
...
\DoxyCodeLine{\Hypertarget{arm__vec__fft_8h_source_l00254}00254\ \ \ \ \ \ \ \ \ vecIn\ =\ vldrdq\_gather\_offset\_u64(pSrc,\ (uint64x2\_t)\ bitRevOffs0);}
...
\DoxyCodeLine{\Hypertarget{arm__vec__fft_8h_source_l00260}00260\ \ \ \ \ \ \ \ \ vecIn\ =\ vldrdq\_gather\_offset\_u64(pSrc,\ (uint64x2\_t)\ bitRevOffs1);}
...
\DoxyCodeLine{\Hypertarget{arm__vec__fft_8h_source_l00278}00278\ }
\DoxyCodeLine{\Hypertarget{arm__vec__fft_8h_source_l00279}00279\ \mbox{\hyperlink{_core_2_include_2cmsis__armcc_8h_aba87361bfad2ae52cfe2f40c1a1dbf9c}{\_\_STATIC\_INLINE}}\ \textcolor{keywordtype}{void}\ arm\_bitreversal\_16\_outpl\_mve(\textcolor{keywordtype}{void}\ *pDst,\ \textcolor{keywordtype}{void}\ *pSrc,\ uint32\_t\ fftLen)}
